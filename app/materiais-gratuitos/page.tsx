...
export default async function FreeMaterialsPage({ searchParams }: { searchParams: Promise<{ material?: string | string[] }> }) {
  ...
  return <div className="page-shell"><SiteHeader /><main>
    ...
    <section className="free-library-section"><div className="container"><div className="free-section-heading"><span className="eyebrow">Biblioteca CPPEM</span><h2 className="display-title">Escolha sua próxima <span className="gold">ferramenta.</span></h2><p>Todo o acervo abaixo continua sendo administrado pela equipe no Notion.</p></div><ContentLibrary items={materials} kind="materials" initialSelectedId={initialSelectedId} /></div></section>
