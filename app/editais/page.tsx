...
export default async function NoticesPage() {
  ...
  return <div className="page-shell"><SiteHeader /><main>
    ...
    <section className="free-library-section"><div className="container"><div className="free-section-heading"><span className="eyebrow">Editais CPPEM</span><h2 className="display-title">Encontre o seu <span className="gold">concurso.</span></h2><p>Os arquivos ativos são lidos diretamente da base editorial do Notion.</p></div><ContentLibrary items={notices} kind="notices" /></div></section>
